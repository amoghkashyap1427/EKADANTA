...
class BootScene(BaseScene):
    def __init__(self, game):
        ...
        self.title_rect = self.title_text.get_rect(center=(LOGICAL_WIDTH//2, LOGICAL_HEIGHT//2 - 50))
        self.subtitle_rect = self.subtitle_text.get_rect(center=(LOGICAL_WIDTH//2, LOGICAL_HEIGHT//2 + 20))
        self.info_rect = self.info_text.get_rect(center=(LOGICAL_WIDTH//2, LOGICAL_HEIGHT//2 + 100))
